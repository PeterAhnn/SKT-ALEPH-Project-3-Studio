...
createServer(async (req,res) => {
  ...
  if (!/^\/(index.html|style.css|app.js|core.js|theme.js|theme.css|fonts.js|storage.js)?$/.test(path)&&!/^\/fonts\/[A-Za-z0-9.-]+\.(ttf|woff2|txt|html)$/.test(path)) { res.writeHead(404); return res.end('Not found'); }
